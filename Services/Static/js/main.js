...
(function($) {
   ...
   /* --------------------------------------------------- */
	...
	$(".main-content-slides").vegas({
		...
		delay: 5000,
    	slides: [
       	/*{ src: "/Static/images/slides/orders.jpg" },*/
        { src: "/Static/images/slides/BirthdayParties.jpg" },
        { src: "/Static/images/slides/Anniversary.jpg" },
		{ src: "/Static/images/slides/AHall.jpg" },
		{ src: "/Static/images/slides/Georgian-terrace-hotel-decor-color.jpg" }
    	]
	});
